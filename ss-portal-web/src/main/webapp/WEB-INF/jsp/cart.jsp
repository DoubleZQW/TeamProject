...
<section class="cartMain">
        ...
        <div class="order_content">
            <ul class="order_lists">
                ...
                <li class="list_con">
                    ...
                    <div class="list_text"><a href="javascript:;">美味的食物</a></div>
                </li>
                <li class="list_info">
                    <p>规格：默认</p>
                    <p>尺寸：16*16*3(cm)</p>
    ...
    <div class="bar-wrapper">
        <div class="bar-right">
            ...
            <div class="calBtn"><a href="https://www.alipay.com/">结算</a></div>
        </div>
    </div>
</section>
